...
public class OnlineActivity extends AppCompatActivity {
    ...
    DatabaseReference databaseReference = FirebaseDatabase.getInstance().getReferenceFromUrl("https://tictactoe-52139-default-rtdb.firebaseio.com");
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        progressDialog.setMessage("Czekam na przeciwnika");
        progressDialog.show();
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if(snapshot.hasChild("player_id")){
                    ...
                    if(getWinPlayerId.equals(playerUniqueId)){
                        winDialog = new WinDialog(OnlineActivity.this, "Wygrałeś");
                    }
                    else{
                        winDialog = new WinDialog(OnlineActivity.this, "Przegrałeś");
                    }
    ...
    private void selectBox(ImageView imageView, int selectedBoxPosition, String selectedByPlayer){
        ...
        if(doneBoxes.size() == 9){
            final WinDialog winDialog = new WinDialog(OnlineActivity.this, "Remis");
            winDialog.setCancelable(false);
            winDialog.show();
        }
    }
